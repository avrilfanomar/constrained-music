...
CONSTRAINTS = [
    # Melodic
    {"id": "leap_recovery", "label": "Leap Recovery", "category": "melodic", "type": "soft", "default_weight": 75,
     "description": "After leap >= 5 semitones, move in opposite direction"},
    {"id": "mostly_stepwise", "label": "Stepwise Motion", "category": "melodic", "type": "soft", "default_weight": 70,
     "description": "Prefer stepwise motion (intervals <= 2 semitones)"},
    {"id": "no_consecutive_same_direction_leaps", "label": "No Consecutive Leaps", "category": "melodic", "type": "soft", "default_weight": 80,
     "description": "Avoid two consecutive leaps in same direction"},
    {"id": "approach_climax_by_step", "label": "Approach Climax Stepwise", "category": "melodic", "type": "soft", "default_weight": 65,
     "description": "Highest note should be approached stepwise"},
    {"id": "leave_climax_contrary", "label": "Leave Climax Downward", "category": "melodic", "type": "soft", "default_weight": 60,
     "description": "After highest note, descend"},
    {"id": "single_climax", "label": "Single Peak", "category": "melodic", "type": "soft", "default_weight": 50,
     "description": "One clear highest point in middle third"},
    {"id": "balanced_motion", "label": "Balanced Motion", "category": "melodic", "type": "soft", "default_weight": 55,
     "description": "Roughly equal ascending and descending intervals"},
    {"id": "min_unique_pitches", "label": "Pitch Variety", "category": "melodic", "type": "soft", "default_weight": 60,
     "description": "Minimum number of distinct pitches"},
    {"id": "max_octave_leaps", "label": "Limit Octave Leaps", "category": "melodic", "type": "soft", "default_weight": 70,
     "description": "Limit leaps of octave or larger"},
    {"id": "no_immediate_repeat", "label": "No Repeated Notes", "category": "melodic", "type": "soft", "default_weight": 50,
     "description": "No immediate pitch repetition"},
    {"id": "prefer_smaller_intervals", "label": "Prefer Small Intervals", "category": "melodic", "type": "soft", "default_weight": 60,
     "description": "Penalize intervals proportionally to size beyond stepwise"},
    {"id": "no_repetitive_intervals", "label": "Avoid Repeated Intervals", "category": "melodic", "type": "soft", "default_weight": 65,
     "description": "Avoid consecutive identical intervals (same direction and size)"},
    {"id": "large_leap_recovery", "label": "Large Leap Recovery", "category": "melodic", "type": "soft", "default_weight": 75,
     "description": "Large leaps (8+ semitones) require stepwise motion on both sides"},
    {"id": "consonant_leaps_only", "label": "Consonant Leaps Only", "category": "melodic", "type": "soft", "default_weight": 85,
     "description": "Leaps should be consonant (3rds, 4ths, 5ths, 6ths, octaves)"},
    {"id": "peak_approach_exit", "label": "Peak Approach & Exit", "category": "melodic", "type": "soft", "default_weight": 70,
     "description": "Peak approached from below, left by descending step"},
    {"id": "salient_climax", "label": "Prominent Climax", "category": "melodic", "type": "soft", "default_weight": 55,
     "description": "Highest note should be at least 3 semitones above second-highest"},
    {"id": "octave_leap_recovery", "label": "Octave Leap Recovery", "category": "melodic", "type": "soft", "default_weight": 80,
     "description": "Octave leaps (12+ semitones) require stepwise motion on both sides"},
    {"id": "no_melodic_parallel_fifths", "label": "No Melodic Parallel Fifths", "category": "melodic", "type": "soft", "default_weight": 65,
     "description": "Avoid consecutive perfect fifths outlined in the melody"},
    # Harmonic
    {"id": "leading_tone_resolution", "label": "Leading Tone Resolution", "category": "harmonic", "type": "soft", "default_weight": 85,
     "description": "Scale degree 7 resolves up to tonic"},
    {"id": "no_leading_tone_emphasis", "label": "Limit Leading Tone", "category": "harmonic", "type": "soft", "default_weight": 70,
     "description": "Avoid overusing leading tone"},
    {"id": "chord_tone_on_strong_beats", "label": "Strong Beats on Chord Tones", "category": "harmonic", "type": "soft", "default_weight": 70,
     "description": "Notes on strong beats should be chord tones (root, 3rd, 5th)"},
    # Phrase Structure
    {"id": "phrase_ends_stable", "label": "Stable Phrase Endings", "category": "phrase_structure", "type": "soft", "default_weight": 80,
     "description": "Phrase ends on stable tone (1, 3, or 5)"},
    {"id": "antecedent_consequent", "label": "Question-Answer Phrases", "category": "phrase_structure", "type": "soft", "default_weight": 55,
     "description": "Half cadence then full cadence structure"},
    {"id": "arch_contour", "label": "Arch Shape", "category": "phrase_structure", "type": "soft", "default_weight": 50,
     "description": "Rise then fall melodic shape"},
    {"id": "tonic_anchoring", "label": "Tonic Anchoring", "category": "phrase_structure", "type": "soft", "default_weight": 55,
     "description": "Tonic appears regularly"},
    {"id": "opening_gesture", "label": "Classical Opening", "category": "phrase_structure", "type": "soft", "default_weight": 60,
     "description": "Opening follows common Classical patterns"},
    {"id": "phrase_arch_contour", "label": "Phrase Arch", "category": "phrase_structure", "type": "soft", "default_weight": 65,
     "description": "Peak in middle third, ascending first half, descending second half"},
    {"id": "cadential_descent", "label": "Descending Cadence", "category": "phrase_structure", "type": "soft", "default_weight": 70,
     "description": "Final portion descends stepwise toward tonic"},
    {"id": "registral_return", "label": "Return to Opening Register", "category": "phrase_structure", "type": "soft", "default_weight": 50,
     "description": "First and last notes should be within an octave for balance"},
    # Cadence
    {"id": "authentic_cadence_melody", "label": "Authentic Cadence", "category": "cadence", "type": "soft", "default_weight": 75,
     "description": "Phrase ends with 2-1 or 7-1 melodic cadence pattern"},
    {"id": "half_cadence_melody", "label": "Half Cadence", "category": "cadence", "type": "soft", "default_weight": 65,
     "description": "Antecedent phrases end on scale degree 2, 5, or 7"},
    {"id": "phrase_rhyme", "label": "Phrase Rhyme", "category": "cadence", "type": "soft", "default_weight": 60,
     "description": "Consequent phrase opens similarly to antecedent (melodic rhyme)"},
    # Motivic
    {"id": "sequence_encouraged", "label": "Melodic Sequences", "category": "motivic", "type": "soft", "default_weight": 65,
     "description": "Encourage at least one melodic sequence"},
    {"id": "motivic_repetition", "label": "Recurring Motifs", "category": "motivic", "type": "soft", "default_weight": 55,
     "description": "Encourage recurring interval patterns for melodic coherence"},
    {"id": "motivic_fragmentation", "label": "Motif Development", "category": "motivic", "type": "soft", "default_weight": 50,
     "description": "First-quarter interval patterns reappear in second half"},
    # Idiomatic
    {"id": "register_consistency", "label": "Register Consistency", "category": "idiomatic", "type": "soft", "default_weight": 55,
     "description": "Penalize consecutive intervals exceeding an octave"},
    {"id": "no_parallel_fifths_single", "label": "No Hidden Fifths", "category": "voice_leading", "type": "soft", "default_weight": 75,
     "description": "Avoid tritone in single voice (pseudo-parallel 5th)"},
    # Emotional
    {"id": "descending_motion", "label": "Falling Contour", "category": "emotional", "type": "soft", "default_weight": 50,
     "description": "Penalize ascending intervals (sad melodies gravitate downward)"},
    {"id": "ascending_motion", "label": "Rising Contour", "category": "emotional", "type": "soft", "default_weight": 50,
     "description": "Penalize descending intervals (joyful melodies tend to rise)"},
    {"id": "narrow_range", "label": "Narrow Range", "category": "emotional", "type": "soft", "default_weight": 50,
     "description": "Penalize wide pitch range (calm music stays in narrow register)"},
    {"id": "contour_smoothness", "label": "Smooth Flow", "category": "emotional", "type": "soft", "default_weight": 50,
     "description": "Penalize direction changes (peaceful melodies flow smoothly)"},
    {"id": "expressive_leaps", "label": "Dramatic Leaps", "category": "emotional", "type": "soft", "default_weight": 50,
